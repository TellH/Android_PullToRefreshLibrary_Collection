...
import com.tellh.swipetorefreshlayoutgoogle.util.Logger;
 ...
 * </p>
 */
public class SwipeRefreshTestLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = SwipeRefreshTestLayout.class.getSimpleName();
    ...
    /**
     * 内容view，比如ListView、RecyclerView、scrollview等等
     */
    ...
    /**
     * 触发刷新的下拉高度<br>
     * 默认等于mSpinnerFinalOffset<br>
     * 可通过setDistanceToTriggerSync()方法设置
     */
    ...
    /**
     * 初始化时为mOriginalOffsetTop，表示当前mCircleView的位置（top值）
     */
    ...
    /**
     * Whether this item is scaled up rather than clipped<br>
     * spinner下拉过程是否支持缩放<br>
     * 可以通过setProgressViewEndTarget()和setProgressViewOffset()设置
     */
    ...
    /**
     * -mCircleView.getMeasuredHeight() mCircleView的高度
     */
    ...
    /**
     * 下拉组件Spinner最终停留的高度，默认是由DEFAULT_CIRCLE_TARGET换算过来的值<br>
     * 允许调用setProgressViewOffset和setProgressViewEndTarget来设置
     */
    ...
    /**
     * Whether the client has set a custom starting position;<br>
     * 用户是否通过调用setProgressViewOffset()设置了Spinner开始的位置
     */
    ...
    public void setRefreshing(final boolean refreshing) {
        ...
        if (refreshing && mRefreshing != refreshing) {//启动刷新
            Logger.d();
            // scale and show
            ...
            setTargetOffsetTopAndBottom(endTarget - mCurrentTargetOffsetTop,
                    true /* requires update */);
            mNotify = false;
            //开始mCircleView的显示动画，在动画结束时，会回调onRefresh()方法
...
//        mCircleView.bringToFront();
    ...
    public void setEnableSpinnerScale(boolean b) {
        setProgressViewEndTarget(b, (int) mSpinnerFinalOffset);
    }
    ...
    /**
     * 剩余的以下方法是有关嵌套滑动NestedScrolling，可先不管，不影响对源码的理解
     */
